...
<!--                        <input type="checkbox" id="task---><?php //= $tarefa['id'] ?><!--" class="custom-checkbox">-->
<!--                        <label for="task---><?php //= htmlspecialchars($tarefa['id']) ?><!--">--><?php //= htmlspecialchars($tarefa['titulo']) ?><!--</label>-->
<!--                    </div>-->
<!--                    <div class="icons-container">-->
<!--                   <form action="/editarTarefa" method="POST" style="display:inline;">-->
<!--                       <input type="hidden" name="ids" value="--><?php //= $tarefa['id'] ?><!--">-->
<!--                       <i class="editar-button fa-regular fa-pen-to-square" data-id="--><?php //= $tarefa['id'] ?><!--" data-description="--><?php //= htmlspecialchars($tarefa['descricao']) ?><!--"></i>-->
<!--                   </form>-->
<!---->
<!---->
<!--                       <form action="/deletarTarefa" method="POST" style="display:inline;">-->
<!--                           <input type="hidden" name="delete_id" value="--><?php //= $tarefa['id'] ?><!--">-->
<!--                           <button class="deletar-button" type="submit" style="background:none;border:none;padding:0;">-->
<!--                               <i class="fa-regular fa-trash-can" data-id="--><?php //= $tarefa['id'] ?><!--"></i>-->
<!--                           </button>-->
<!--                       </form>-->
<!---->
<!--                    </div>-->
...
<!--                            <div class="input-name">-->
<!--                                <input type="checkbox" id="task-finished---><?php //= $tarefa['id'] ?><!--" class="custom-checkbox" checked>-->
<!--                                <label for="task-finished---><?php //= htmlspecialchars($tarefa['id']) ?><!--">--><?php //= htmlspecialchars($tarefa['titulo']) ?><!--</label>-->
<!--                            </div>-->
<!--                            <div class="icons-container">-->
<!--                                <i class="fa-regular fa-pen-to-square" data-id="--><?php //= $tarefa['id'] ?><!--"></i>-->
<!--                                <i class="fa-regular fa-trash-can" data-id="--><?php //= $tarefa['id'] ?><!--"></i>-->
<!--                            </div>-->
<!--                        </div>-->
<!--                    --><?php //endif; ?>
